def set_functions():
    from day04 import odd_numbers, divisors, explode, cypher, password_generator, random_integers

    functions = {
        1: ('Get the odd numbers or the odd indices of a list', odd_numbers.get_list),
